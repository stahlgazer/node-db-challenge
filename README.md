...
Relational databases are a way to format and store data in tables, whereas SQL is a language that can be used to work with and manage databases.

- [ ] Why do tables need a `primary key`?
So that each row/entry in a table is unique and can be identified by it's primary key, as well as be able to be referenced by other tables using a foreign key.

- [ ] What is the name given to a table column that references the primary key on another table.
Foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
A third table, which will reference both tables primary key.
